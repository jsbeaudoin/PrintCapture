...
namespace PrintsCapture.Prints.Extension
{
    ...
    public static class BaseSequenceCheckExtension
    {

        public static CapturedPrintData GetCapturedPrintData(this BaseSeqCheckService seq)
        {
            var seqData = seq as ISequencePrints;
            //var seq = this.appParameter.SeqCheckService as LocalAwSeqCheck.LocalSeqCheck;
            if (seq == null || seqData == null)
            {
                return null;
            }
            try
            {
                var prints = seqData.GetCapturedPrints();
                        ...
                        p.ImageInfo = new ImageInformation
                                      {
                                          ...
                                          ImpressionType =
                                              seq.CaptureDevice.Kind == CaptureKind.Livescan
